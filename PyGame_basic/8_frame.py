...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/JLLEE/Desktop/Study/Python/Python_study/PyGame_basic/enemy.png")
...
while running:
    dt = clock.tick(30) # 프레임이 달라진다고 이동 속도가 달라지면 안됨 고정을 해줘야됨
...
# 종료되기 전 잠시 대기
pygame.time.delay(2000) # ms단위 2초 대기
